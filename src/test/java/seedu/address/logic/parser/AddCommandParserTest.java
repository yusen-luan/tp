...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + STUDENT_ID_DESC_BOB
                + EMAIL_DESC_BOB + MODULE_CODE_DESC_AMY + TAG_DESC_FRIEND, new AddCommand(expectedPerson));
        ...
        assertParseSuccess(parser,
                NAME_DESC_BOB + STUDENT_ID_DESC_BOB + EMAIL_DESC_BOB + MODULE_CODE_DESC_AMY
    ...
    public void parse_repeatedNonTagValue_failure() {
        String validExpectedPersonString = NAME_DESC_BOB + STUDENT_ID_DESC_BOB
                + EMAIL_DESC_BOB + MODULE_CODE_DESC_AMY + TAG_DESC_FRIEND;
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        Person expectedPerson = new PersonBuilder().withName(VALID_NAME_AMY)
                ...
                .withModuleCode(VALID_MODULE_CODE_AMY)
                .withTags().build();
        assertParseSuccess(parser, NAME_DESC_AMY + STUDENT_ID_DESC_AMY
                + EMAIL_DESC_AMY + MODULE_CODE_DESC_AMY, new AddCommand(expectedPerson));
    }
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing name prefix
        assertParseFailure(parser, VALID_NAME_BOB + STUDENT_ID_DESC_BOB
                + EMAIL_DESC_BOB + MODULE_CODE_DESC_AMY, expectedMessage);

        // missing student ID prefix
        assertParseFailure(parser, NAME_DESC_BOB + VALID_STUDENT_ID_BOB
                + EMAIL_DESC_BOB + MODULE_CODE_DESC_AMY, expectedMessage);

        // missing email prefix
        assertParseFailure(parser, NAME_DESC_BOB + STUDENT_ID_DESC_BOB
                + VALID_EMAIL_BOB + MODULE_CODE_DESC_AMY, expectedMessage);

        // missing module code prefix
        assertParseFailure(parser, NAME_DESC_BOB + STUDENT_ID_DESC_BOB
                + EMAIL_DESC_BOB + VALID_MODULE_CODE_AMY, expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_NAME_BOB + VALID_STUDENT_ID_BOB
                + VALID_EMAIL_BOB + VALID_MODULE_CODE_AMY, expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + STUDENT_ID_DESC_BOB + EMAIL_DESC_BOB
                + MODULE_CODE_DESC_AMY + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Name.MESSAGE_CONSTRAINTS);

        // invalid student ID
        assertParseFailure(parser, NAME_DESC_BOB + INVALID_STUDENT_ID_DESC + EMAIL_DESC_BOB
                + MODULE_CODE_DESC_AMY + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, StudentId.MESSAGE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, NAME_DESC_BOB + STUDENT_ID_DESC_BOB + INVALID_EMAIL_DESC
                + MODULE_CODE_DESC_AMY + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Email.MESSAGE_CONSTRAINTS);
        ...
        // invalid tag
        assertParseFailure(parser, NAME_DESC_BOB + STUDENT_ID_DESC_BOB + EMAIL_DESC_BOB
                + MODULE_CODE_DESC_AMY + INVALID_TAG_DESC + VALID_TAG_FRIEND, Tag.MESSAGE_CONSTRAINTS);
        ...
        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + STUDENT_ID_DESC_BOB
                + EMAIL_DESC_BOB + MODULE_CODE_DESC_AMY + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddCommand.MESSAGE_USAGE));
    }

    @Test
    public void parse_multipleModuleCodes_success() {
        // multiple module codes - all accepted
        Person expectedPerson = new PersonBuilder().withName(VALID_NAME_BOB)
                .withStudentId(VALID_STUDENT_ID_BOB)
                .withEmail(VALID_EMAIL_BOB)
                .withModuleCodes(VALID_MODULE_CODE_AMY, VALID_MODULE_CODE_BOB)
                .withTags(VALID_TAG_FRIEND)
                .build();

        assertParseSuccess(parser, NAME_DESC_BOB + STUDENT_ID_DESC_BOB + EMAIL_DESC_BOB
                + MODULE_CODE_DESC_AMY + MODULE_CODE_DESC_BOB + TAG_DESC_FRIEND,
